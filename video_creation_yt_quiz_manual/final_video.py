...
def make_final_video(
    ...
    for i in range(0, number_of_clips):
        ...
        if i>=0:
            ...
            # final_clip = final_clip.set_audio(audio_que).fx(vfx.fadein,1).fx(vfx.fadeout,1)

            credits1 = (TextClip(reddit_obj['comments'][i]['image_ans'],align="West", color='white', font="Arial-Bold",kerning=1, interline=1, size=(W-100, H-300), method='caption').set_duration(audio_ans.duration))

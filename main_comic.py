...
from moviepy.editor import TextClip, vfx,transfx,afx,ColorClip
...
def download_screenshots_of_reddit_posts():
    ...
    credits1 = (TextClip("asddfa asdfa asdfa asddfa asd ",color='black', font="Arial-Bold",kerning=1, interline=1, size=(W-100, H-100), method='caption'))
    credits1 = credits1.set_position('center')
    colorclip = ColorClip(size=(W, H), color=(255,255,255))
    final_clip1 = CompositeVideoClip([colorclip, credits1])
    final_clip1 = final_clip1.set_position('center')
    final_clip1.save_frame(f"out_ans.png")
    exit()

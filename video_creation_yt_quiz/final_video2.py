...
def make_final_video(
    ...
    for i in range(0, number_of_clips):
        ...
        credits = (TextClip(reddit_obj['comments'][i]['image_que_ans'].encode('utf-8'),  align="West", color='white', kerning=1, interline=1, size=(W-100, H-350), method='caption').set_duration(audio_que.duration))
        ...
        final_clip = final_clip.set_audio(audio_que).fx( vfx.speedx, 0.9)
        video_clip = (
        ...
        credits1 = (TextClip(reddit_obj['comments'][i]['image_ans'].encode('utf-8'), align="West", color='white', kerning=1, interline=1, size=(W-100, H-300), method='caption',fontsize=50).set_duration(audio_ans.duration))
        credits1 = credits1.set_position((50,50))
        colorclip = ColorClip(size=(W, H), color=(0, 0, 0)).set_opacity(0.5).set_duration(audio_ans.duration)
        ...
        credits = (TextClip(reddit_obj['comments'][i]['image_que_ans'].encode('utf-8'),  align="West", color='white',kerning=1, interline=1, size=(W-100, H-100), method='caption').set_duration(audio_que.duration))
        credits = credits.set_position((50, 50))
        colorclip = ColorClip(size=(W, H), color=(0, 0, 0)).set_opacity(0.5).set_duration(audio_que.duration)
        final_clip = CompositeVideoClip([colorclip, credits])
        final_clip = final_clip.set_position('center')
        ...
        credits1 = (TextClip(reddit_obj['comments'][i]['image_ans'].encode('utf-8'), align="West", color='white', kerning=1, interline=1, size=(W-100, H-100), method='caption').set_duration(audio_ans.duration))
        credits1 = credits1.set_position((50,50))
        colorclip = ColorClip(size=(W, H), color=(0, 0, 0)).set_opacity(0.5).set_duration(audio_ans.duration)
        final_clip1 = CompositeVideoClip([colorclip, credits1])
        final_clip1 = final_clip1.set_position('center')

...
def download_screenshots_of_reddit_posts():
    ...
    with sync_playwright() as p:
        ...
        if len(url)>10:
            ...
            f= open("youtube_comics/the-beautiful-wife-of-the-whirlwind-marriage-comics-wuxia-dao-novel.txt", 'r')
            url = f.readlines()[-1]
            f.close()
...
while 1:
    ...
    #         EFFECT_DURATION = 5
    #         CLIP_DURATION = 25
    #         clips.append(ImageClip(f"assets/temp/png1/comment_{i}.png").set_duration(CLIP_DURATION).resize(height=H).set_opacity(new_opacity))
    ...
    # audio = AudioFileClip(f"audio/{random.randint(1, 14)}.mp3").fx(afx.volumex,0.1)
    # print(audio.duration)
    # print(video.duration)
    # if audio.duration<video.duration:
    #     audio1 = AudioFileClip(f"audio/{random.randint(1, 14)}.mp3")
    #     audio2 = AudioFileClip(f"audio/{random.randint(1, 14)}.mp3")
    #     if audio1.duration+audio2.duration<video.duration:
    #         audio3 = AudioFileClip(f"audio/{random.randint(1, 14)}.mp3")
    ...
    video = (
        VideoFileClip(f"results/comic1.mp4")
    )
    ...
    fd=open("youtube_comics/the-beautiful-wife-of-the-whirlwind-marriage-comics-wuxia-dao-novel.txt","r")
    d=fd.read()
    fd.close()
    m=d.split("\n")
    s="\n".join(m[:-1])
    fd=open("youtube_comics/the-beautiful-wife-of-the-whirlwind-marriage-comics-wuxia-dao-novel.txt","w+")

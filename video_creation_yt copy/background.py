...
background_options = {
    ...
    "quiz": (  # GTA Stunt Race
        "https://www.youtube.com/watch?v=zsi0FT5zljo",
        "cyberpunk.mp4",
        "MG1010",
        lambda t: ("center", 480 + t),
    ),
    "quiz1": (  # GTA Stunt Race
        "https://www.youtube.com/watch?v=2sOSiNQoVgc",
        "cyberpunk_brain.mp4",
        "MG1010",
        lambda t: ("center", 480 + t),
    ),
    "quiz2": (  # GTA Stunt Race
        "https://www.youtube.com/watch?v=ppcMRhT1wes",
        "cyberpunk_rocket.mp4",
        "MG1010",
        lambda t: ("center", 480 + t),
    ),
    "quiz3": (  # GTA Stunt Race
        "https://www.youtube.com/watch?v=mEqcala-NiE",
        "Digital_White_Lines.mp4",
        "Josu Relax",
        lambda t: ("center", 480 + t),
    ),
    "quiz4": (  # GTA Stunt Race
        "https://www.youtube.com/watch?v=COv-TEtLrAg",
        "Neon_Lines.mp4",
        "MG1010",
        lambda t: ("center", 480 + t),
    ),
    "quiz5": (  # GTA Stunt Race
        "https://www.youtube.com/watch?v=HdW2yvkAB2U",
        "Cyberpunk_city.mp4",
        "MG1010",
        lambda t: ("center", 480 + t),
    ),
    "quiz6": (  # GTA Stunt Race
